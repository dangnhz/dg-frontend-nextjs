...
const ProjectBody = dynamic(() => import('./ProjectBody'))
const FeatureImage = dynamic(() => import('../FeatureImage'))
const ProjectBreakout = dynamic(() => import('./ProjectBreakout'))
const ProjectMosaic = dynamic(() => import('./ProjectMosaic'))
const ProjectSlider = dynamic(() => import('./ProjectSlider'))
const ProjectResult = dynamic(() => import('./ProjectResult'))
    ...
    <>
      ...
      <div className="page-inner">
        <div
          ...
          style={
            {
              '--project-primary-color': project?.primaryColor,
              '--project-secondary-color': project?.secondaryColor,
            } as CustomCSS
          }
        >
          <ProjectBanner {...project.projectBanner} />
          {typeof project.projectIntro === 'object' &&
            project.projectIntro !== null &&
            !Array.isArray(project.projectIntro) && <ProjectIntro {...project.projectIntro} />}
          ...
          {typeof project.projectBodyCopy === 'object' &&
            project.projectBodyCopy !== null &&
            !Array.isArray(project.projectBodyCopy) && <ProjectBody {...project.projectBodyCopy} />}
          {typeof project.projectMosaic === 'object' &&
            project.projectMosaic !== null &&
            !Array.isArray(project.projectMosaic) && <ProjectMosaic {...project.projectMosaic} />}
          {typeof project.projectBreakout === 'object' &&
            project.projectBreakout !== null &&
            !Array.isArray(project.projectBreakout) && <ProjectBreakout {...project.projectBreakout} />}
          ...
          {typeof project.projectResults === 'object' &&
            project.projectResults !== null &&
            !Array.isArray(project.projectResults) && <ProjectResult {...project.projectResults} />}
