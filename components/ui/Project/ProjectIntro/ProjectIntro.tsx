  ...
  return (
    ...
    >
      <div
        className={cx(
          "project-intro-inner",
          "padding-horizontal max-width-5 mx-auto"
        )}
      >
        <Flex gap="lg">
          <Column>
          ...
          <Column width="60%">
            <div className={cx("right-column")} ref={rightColRef}>
              <div
                className={cx("project-intro-text", "body-copy")}
              ...
              {whatWeDid?.length > 0 && (
                <div className={cx("project-intro-what-we-did")}>
                  ...
                  <div
                    className={cx(
                      "project-intro-what-we-did-listing",
                      "body-copy"
                    )}
                  >
                    <ul>
